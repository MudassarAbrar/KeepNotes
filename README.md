...
![](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=keepnotes&fontSize=60&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=A%20fast%2C%20simple%20terminal-based%20todo%20%26%20note-keeping%20CLI&descAlignY=55&descSize=18)

![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=No+browser%2C+no+GUI+%E2%80%94+just+your+terminal;Add%2C+track+%26+manage+tasks+instantly;Local-first.+Your+data+never+leaves+your+machine;Built+with+Node.js)
...
![](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=20,11,6&height=120&section=footer)
